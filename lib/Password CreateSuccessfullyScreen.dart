...
class PasswordCreateSuccessfulScreen extends StatefulWidget {
  const PasswordCreateSuccessfulScreen({Key? key}) : super(key: key);

  @override
  State<PasswordCreateSuccessfulScreen> createState() => _PasswordCreateSuccessfulScreenState();
}

class _PasswordCreateSuccessfulScreenState extends State<PasswordCreateSuccessfulScreen> {
  String fullName = '';
